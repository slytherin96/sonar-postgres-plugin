...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 50: {
            ...
            defresult_ = input.readMessage(com.premiumminds.sonar.postgres.protobuf.Node.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.premiumminds.sonar.postgres.protobuf.CaseExpr parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.premiumminds.sonar.postgres.protobuf.CaseExpr) e.getUnfinishedMessage();
    ...
    public Builder mergeDefresult(com.premiumminds.sonar.postgres.protobuf.Node value) {
      if (defresultBuilder_ == null) {
        if (defresult_ != null) {
          defresult_ =
            com.premiumminds.sonar.postgres.protobuf.Node.newBuilder(defresult_).mergeFrom(value).buildPartial();
        } else {
          defresult_ = value;
        }
        onChanged();
