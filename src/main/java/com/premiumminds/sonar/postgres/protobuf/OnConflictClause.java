...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.premiumminds.sonar.postgres.protobuf.InferClause.Builder subBuilder = null;
            if (infer_ != null) {
              subBuilder = infer_.toBuilder();
            }
            infer_ = input.readMessage(com.premiumminds.sonar.postgres.protobuf.InferClause.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.premiumminds.sonar.postgres.protobuf.OnConflictClause parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.premiumminds.sonar.postgres.protobuf.OnConflictClause) e.getUnfinishedMessage();
    ...
    public Builder mergeInfer(com.premiumminds.sonar.postgres.protobuf.InferClause value) {
      if (inferBuilder_ == null) {
        if (infer_ != null) {
          infer_ =
            com.premiumminds.sonar.postgres.protobuf.InferClause.newBuilder(infer_).mergeFrom(value).buildPartial();
        } else {
          infer_ = value;
        }
        onChanged();
