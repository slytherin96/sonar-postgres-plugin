...
public interface IndexStmtOrBuilder extends
   ...
   * <code>repeated .pg_query.Node index_params = 5 [json_name = "indexParams"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getIndexParams(int index);
  /**
   * <code>repeated .pg_query.Node index_params = 5 [json_name = "indexParams"];</code>
   */
   ...
   * <code>repeated .pg_query.Node index_params = 5 [json_name = "indexParams"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getIndexParamsOrBuilder(
      int index);
   ...
   * <code>repeated .pg_query.Node index_including_params = 6 [json_name = "indexIncludingParams"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getIndexIncludingParams(int index);
  /**
   * <code>repeated .pg_query.Node index_including_params = 6 [json_name = "indexIncludingParams"];</code>
   */
   ...
   * <code>repeated .pg_query.Node index_including_params = 6 [json_name = "indexIncludingParams"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getIndexIncludingParamsOrBuilder(
      int index);
   ...
   * <code>repeated .pg_query.Node exclude_op_names = 9 [json_name = "excludeOpNames"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getExcludeOpNames(int index);
  /**
   * <code>repeated .pg_query.Node exclude_op_names = 9 [json_name = "excludeOpNames"];</code>
   */
   ...
   * <code>repeated .pg_query.Node exclude_op_names = 9 [json_name = "excludeOpNames"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getExcludeOpNamesOrBuilder(
      int index);
