...
public interface AlterPublicationStmtOrBuilder extends
   ...
   * <code>repeated .pg_query.Node tables = 3 [json_name = "tables"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getTables(int index);
  /**
   * <code>repeated .pg_query.Node tables = 3 [json_name = "tables"];</code>
   */
  int getTablesCount();
   ...
   * <code>repeated .pg_query.Node tables = 3 [json_name = "tables"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getTablesOrBuilder(
      int index);
   ...
   */
  com.premiumminds.sonar.plpgsql.protobuf.DefElemAction getTableAction();
}
