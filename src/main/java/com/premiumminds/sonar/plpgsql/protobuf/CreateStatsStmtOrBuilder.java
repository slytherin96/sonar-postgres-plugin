...
public interface CreateStatsStmtOrBuilder extends
   ...
   * <code>repeated .pg_query.Node stat_types = 2 [json_name = "stat_types"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getStatTypes(int index);
  /**
   * <code>repeated .pg_query.Node stat_types = 2 [json_name = "stat_types"];</code>
   */
   ...
   * <code>repeated .pg_query.Node stat_types = 2 [json_name = "stat_types"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getStatTypesOrBuilder(
      int index);
   ...
   * <code>repeated .pg_query.Node exprs = 3 [json_name = "exprs"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getExprs(int index);
  /**
   * <code>repeated .pg_query.Node exprs = 3 [json_name = "exprs"];</code>
   */
  int getExprsCount();
   ...
   * <code>repeated .pg_query.Node exprs = 3 [json_name = "exprs"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getExprsOrBuilder(
      int index);
