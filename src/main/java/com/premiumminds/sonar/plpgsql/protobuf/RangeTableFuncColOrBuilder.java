...
public interface RangeTableFuncColOrBuilder extends
   ...
   * @return The colexpr.
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getColexpr();
  /**
   * <code>.pg_query.Node colexpr = 5 [json_name = "colexpr"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getColexprOrBuilder();
   ...
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getColdefexpr();
  /**
   * <code>.pg_query.Node coldefexpr = 6 [json_name = "coldefexpr"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getColdefexprOrBuilder();
