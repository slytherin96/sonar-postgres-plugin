...
public interface CreateOpClassItemOrBuilder extends
   ...
   * @return The name.
   */
  com.premiumminds.sonar.plpgsql.protobuf.ObjectWithArgs getName();
  /**
   * <code>.pg_query.ObjectWithArgs name = 2 [json_name = "name"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.ObjectWithArgsOrBuilder getNameOrBuilder();
   ...
   * <code>repeated .pg_query.Node order_family = 4 [json_name = "order_family"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getOrderFamily(int index);
  /**
   * <code>repeated .pg_query.Node order_family = 4 [json_name = "order_family"];</code>
   */
   ...
   * <code>repeated .pg_query.Node order_family = 4 [json_name = "order_family"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getOrderFamilyOrBuilder(
      int index);
   ...
   * <code>repeated .pg_query.Node class_args = 5 [json_name = "class_args"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.Node getClassArgs(int index);
  /**
   * <code>repeated .pg_query.Node class_args = 5 [json_name = "class_args"];</code>
   */
   ...
   * <code>repeated .pg_query.Node class_args = 5 [json_name = "class_args"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.NodeOrBuilder getClassArgsOrBuilder(
      int index);
   ...
   */
  com.premiumminds.sonar.plpgsql.protobuf.TypeName getStoredtype();
  /**
   * <code>.pg_query.TypeName storedtype = 6 [json_name = "storedtype"];</code>
   */
  com.premiumminds.sonar.plpgsql.protobuf.TypeNameOrBuilder getStoredtypeOrBuilder();
}
